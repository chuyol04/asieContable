...
import { getClientForUser, listPayrollFiles } from "@/features/clients/service";
import { parsePeriodFilter } from "@/features/clients/validation";
...
export default async function MyPayrollPage({ searchParams }: PageProps<"/mis-nominas">) {
  ...
  const files = client ? await listPayrollFiles(client.id, { ...filters, activeOnly: true }) : [];
